...
import Qualityacnotableverify from './Qualityacnotableverify';

const QualityVerification = ({ update }) => {
                    ...
                    <div className="col-md-12">
                        <div className="row">
                            ...
                            <div>
                                ...
                                {search === true ? <Qualityacnotableverify frdate={moment(monthwise).format("MM")}
                                    setSearch={setSearch} Setmonthval={Setmonthval} monthval={monthval} /> : null}
