...
import Reportopoverall from './Reportopoverall'

// const moment = extendMoment(Moment);


const Monthlyreportdetl = () => {
            ...
            <div className="card">
                ...
                <div className="card-body">
                    <div className="col-md-12">
                        <div className="row">
                            <Reportopoverall monthdetl={monthdetl}
...
export default Monthlyreportdetl
